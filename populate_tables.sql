...
insert into consultation values ('204-53-2647', '2013-7-16', 'ultrices aliquet maecenas leo odio condimentum id luctus nec molestie sed justo pellentesque viverra pede ac diam cras', 'lorem id ligula gengivitis ornare consequat lectus in est risus auctor sed tristique in tempus sit amet sem', 'id consequat in consequat ut nulla sed accumsan felis ut at dolor quis odio consequat varius', 'rhoncus mauris enim leo rhoncus sed vestibulum sit amet cursus id turpis integer aliquet massa id');
